...
import {SET_PERMISSION,CLEAR_PERMISSION,SET_MENU,CLEAR_MENU,SET_CURRENT_MENU} from '../types'
...
export default {
    ...
    actions: {
        async FETCH_PERMISSION({ commit, state }) {
            ...
            let routes = recursionRouter(JSON.parse(data.permission), dynamicRouter)
